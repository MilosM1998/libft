...
#    Updated: 2024/09/07 14:59:11 by mmilicev         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRC = ft_isalpha.c ft_isdigit.c ft_isascii.c ft_isprint.c ft_strlen.c ft_memset.c \
	  ...
	  ft_putstr_fd.c ft_putendl_fd.c ft_putchar_fd.c ft_putnbr_fd.c ft_itoa.c 
